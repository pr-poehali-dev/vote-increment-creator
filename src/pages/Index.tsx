  ...
  const reviews = [
    {
      ...
      avatar: 'AM',
      rating: 5,
      text: 'Накрутка голосов прошла отлично! Заказал 500 голосов для конкурса ВК, всё пришло за 8 часов. Рекомендую эту накрутку голосов!',
      platform: 'ВКонтакте'
    },
    {
      name: 'Екатерина П.',
      avatar: 'ЕП',
      rating: 5,
      text: 'Профессиональная накрутка голосов! Быстро, качественно, без блокировок. Уже третий раз заказываю накрутку голосов здесь.',
      platform: 'Instagram'
    },
    {
      name: 'Дмитрий К.',
      avatar: 'ДК',
      rating: 5,
      text: 'Лучшая накрутка голосов! Поддержка ответила моментально, всё объяснили. Безопасная накрутка голосов с гарантией.',
      platform: 'Facebook'
    },
    {
      name: 'Мария С.',
      avatar: 'МС',
      rating: 5,
      text: 'Заказала накрутку голосов для участия в голосовании. Результат превзошел ожидания! Быстрая накрутка голосов помогла победить.',
      platform: 'ВКонтакте'
    },
    {
      name: 'Игорь В.',
      avatar: 'ИВ',
      rating: 5,
      text: 'Накрутка голосов работает отлично! Заказывал для продвижения поста в Instagram. Качественная накрутка голосов без рисков.',
      platform: 'Instagram'
    },
    {
      name: 'Анна Л.',
      avatar: 'АЛ',
      rating: 5,
      text: 'Эффективная накрутка голосов! Помогла выиграть конкурс на Facebook. Надежная накрутка голосов с быстрым результатом.',
      platform: 'Facebook'
    }
  ];
